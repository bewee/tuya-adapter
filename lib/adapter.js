  ...
  constructor(addonManager) {
    ...
    this.db.open().then((() => {
      ...
      for (const conf of this.config.devices) {
        ...
        switch (conf.type) {
          case 'Plug':
            d = new PlugDevice(this, conf);
            break;
          case '1 gang switch':
            d = new SwitchDevice(this, conf, 1);
            break;
          case '2 gang switch':
            d = new SwitchDevice(this, conf.id, 2);
            break;
          case '3 gang switch':
            d = new SwitchDevice(this, conf, 3);
            break;
          case 'Lamp':
            d = new LampDevice(this, conf);
            break;
          case 'Colour Lamp':
            d = new ColourLampDevice(this, conf);
            break;
          default:
            d = new GenericDevice(this, conf);
            break;
        }
