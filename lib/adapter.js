...
const ColourLightDevice = require('./devices/colourlight-device');
  ...
  constructor(addonManager) {
    ...
    this.db.open().then((() => {
      ...
      for (const cid in this.config.devices) {
        ...
        switch (conf.type) {
          case 'Colour Light':
            d = new ColourLightDevice(this, conf, cid);
            break;
          case 'Dimmer':
            d = new DimmerDevice(this, conf, cid);
            break;
          case 'Fireplace heater':
            d = new FireplaceHeaterDevice(this, conf, cid);
            break;
          case 'Light':
            d = new LightDevice(this, conf, cid);
            break;
          case 'Plug':
