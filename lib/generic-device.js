...
const StringProperty = require('./string-property');
const NumberProperty = require('./number-property');
const BooleanProperty = require('./boolean-property');
  ...
  constructor(adapter, tid, key) {
    ...
    this.tuyapi.on('data', ((data) => {
      ...
      for (const dps in data.dps) {
        ...
        prop.setCachedValue(data.dps[dps]);
