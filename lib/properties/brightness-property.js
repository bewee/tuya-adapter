...
class BrightnessProperty extends Property {
  ...
  update(value) {
    this.setCachedValueAndNotify(value/this.device.maxval*100);
  ...
  setValue(value) {
    return new Promise(((resolve, reject) => {
      super.setValue(value).then((updatedValue) => {
        if (this.dps !== null) this.device.tuyapi.set({dps: this.dps, set: parseInt(value*this.device.maxval/100)});
