...
class LighttemperatureProperty extends Property {
  ...
  update(value) {
    this.setCachedValueAndNotify((value*1000/this.device.maxval)*4+2500);
  ...
  setValue(value) {
    return new Promise(((resolve, reject) => {
      super.setValue(value).then((updatedValue) => {
        if (this.dps) this.device.tuyapi.set({dps: this.dps, set: parseInt(((value-2500)/4)*this.device.maxval/1000)});
